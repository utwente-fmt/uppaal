...
import parsable.ParsableFactory;
...
public class ParsablePackageImpl extends EPackageImpl implements ParsablePackage {
	 ...
	 * @see parsable.ParsablePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public static ParsablePackage init() {
		...
		Object registeredPackage = EPackage.Registry.INSTANCE.getEPackage(UppaalSMCPackage.eNS_URI);
		UppaalSMCPackageImpl theUppaalSMCPackage = (UppaalSMCPackageImpl)(registeredPackage instanceof UppaalSMCPackageImpl ? registeredPackage : UppaalSMCPackage.eINSTANCE);
