...
public class UppaalXMLGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class TemplateElements extends AbstractParserRuleElementFinder {
		...
		//Template templates::Template hidden(WS):
		//// The name of the template might have x- and y-coordinates for some reason, they must be skipped.
		// '<' 'name' (('x'
		//	'=' STRING)? & ('y' '=' STRING)?) '>' name=ID '</' 'name' '>' ('<' 'parameter' '>' (parameter+=ParameterContainer
		//	(',' parameter+=ParameterContainer)*)? '</' 'parameter' '>')? ('<' 'declaration' '>' declarations=LocalDeclarations
		//	'</' 'declaration' '>')? // Get all the locations.
		...
		// location+=Location+ // Reference the initial location.
		// '<' 'init'
		//'ref' '=' init=[templates::Location|STRING] '/>' // Get the transitions.
		// edge+=Edge*
		public Group getGroup() { return cGroup; }
	...
	public class LocationElements extends AbstractParserRuleElementFinder {
		...
		// '/>' | // Close the tag.
		// '>' ('<' 'name' (('x' '='
		//	STRING)? & ('y' '=' STRING)?) '>' name=ID '</' 'name' '>')? (('<' 'label' 'kind' '=' '"comments"' (('x' '=' STRING)?
		//	& ('y' '=' STRING)? & ('color' '=' STRING)?) '>' comment=CommentLabel '</' 'label' '>')? & ('<' 'label' 'kind' '='
		//	'"invariant"' (('x' '=' STRING)? & ('y' '=' STRING)? & ('color' '=' STRING)?) '>' invariant=Expression '</' 'label'
		...
		//& ('color' '=' STRING)?) '>' invariant=Expression '</' 'label' '>')?) locationTimeKind=LocationKind? '</' 'location'
		//'>'
	...
	public class EdgeElements extends AbstractParserRuleElementFinder {
		...
		// '<' 'transition' (('x' '=' STRING)? & ('y' '=' STRING)?
		//	& ('color' '=' colorCode=STRING)?) '>' // Source...
		// '<' 'source' 'ref' '=' source=[templates::Location|STRING] '/>'
		//	// Target...
		// '<' 'target' 'ref' '=' target=[templates::Location|STRING] '/>' (('<' 'label' 'kind' '=' '"comments"'
		//	(('x' '=' STRING)? & ('y' '=' STRING)? & ('color' '=' STRING)?) '>' comment=CommentLabel '</' 'label' '>')? & ('<'
		...
		// '<' 'transition' (('x' '=' STRING)? & ('y' '=' STRING)? & ('color' '='
		//colorCode=STRING)?) '>' // Source...
		...
		//selection+=Selection (',' selection+=Selection)* '</' 'label' '>')?) ('<' 'nail' bendPoint+=Point '/>')*
		//// Close the tag.
		// '</' 'transition' '>'
		public Group getGroup() { return cGroup; }
	...
	public class ChannelPrefixExpressionElements extends AbstractParserRuleElementFinder {
		...
		//broadcast=ChannelPrefixExpression_Broadcast? | broadcast=ChannelPrefixExpression_Broadcast
		//urgent=ChannelPrefixExpression_Urgent?
		public Alternatives getAlternatives_0() { return cAlternatives_0; }
	...
	public class UPPAAL_KEYWORDSElements extends AbstractParserRuleElementFinder {
		...
		//	'before_update' | 'after_update' | 'meta' | 'priority' | 'progress' | 'scalar' | 'select' | 'void' | 'switch' |
